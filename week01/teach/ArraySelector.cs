public static class ArraySelector
{
    public static void Run()
    {
        ...
        var select = new[] { 1, 1, 1, 2, 2, 1, 2, 2, 2, 1}; // this array shows the order of displaying.
    ...
    private static int[] ListSelector(int[] list1, int[] list2, int[] select) // con Liost selector esta usando un puente. 
    {
